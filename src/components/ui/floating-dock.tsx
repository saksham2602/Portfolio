    ...
    <div className={cn("relative block md:hidden", className)}>
      <div className="flex flex-row gap-2 justify-center">
        {items.map((item, idx) => (
          ...
          rel={item.href.startsWith('tel:') || item.href.startsWith('mailto:') ? undefined : 'noopener noreferrer'}
          className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-50 dark:bg-neutral-900 hover:scale-110 transition-transform"
        >
