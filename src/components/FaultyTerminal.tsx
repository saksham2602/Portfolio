...
// Currently unused but kept for future responsive features
...
//   const responsiveGridMul = useMemo((): [number, number] => {
//     if (isMobile) return [1.5, 0.8];
//     if (isTablet) return [1.8, 0.9];
//     return [2, 1];
//   }, [isMobile, isTablet]);

//   const responsiveDigitSize = useMemo(() => {
//     if (isMobile) return 0.9;
//     if (isTablet) return 1.05;
//     return 1.2;
//   }, [isMobile, isTablet]);

//   const responsiveMouseStrength = useMemo(() => {
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uGridMul: { value: new Float32Array(gridMul || [2, 1]) },
